    ...
    setAdditionalResources() {
        this.additionalResources = [
            ...
            },
            {
                ...
                link: `https://pharos.nih.gov/targets?q=${this.gene.hgnc_symbol ? this.gene.hgnc_symbol : this.gene.ensembl_gene_id}`
            },
            {
                title: 'Brain RNAseq',
            ...
            },
            {
                ...
                link: `https://adexplorer.medicine.iu.edu/pubad/external/${this.gene.hgnc_symbol ? this.gene.hgnc_symbol : this.gene.ensembl_gene_id}`
            },
            {
                title: 'Gene Ontology',
