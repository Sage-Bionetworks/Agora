...
describe('Component: GeneComparisonToolDetailsPanelComponent', () => {
    ...
    it('should have label', fakeAsync(() => {
        ...
        const label = fixture.debugElement.nativeElement.querySelector('.gct-details-panel-label');
        expect(label?.innerHTML.trim()).toEqual(mockData.label);
    }));

    it('should have heading', () => {
        // Check if html element is valid
        const heading = fixture.debugElement.nativeElement.querySelector('.gct-details-panel-heading');
        expect(heading?.innerHTML.trim()).toEqual(mockData.heading);
    });

    it('should have subHeading', () => {
        // Check if html element is valid
        const subHeading = fixture.debugElement.nativeElement.querySelector('.gct-details-panel-sub-heading');
        expect(subHeading?.innerHTML.trim()).toEqual(mockData.subHeading);
    });

    it('should have values', () => {
        // Check if html element is valid
        const elements = fixture.debugElement.nativeElement.querySelectorAll('.gct-details-panel-data > div > div');
        expect(elements?.length).toEqual(4);

        expect(elements[0]?.innerHTML.trim()).toEqual(mockData.valueLabel.toString());
    ...
    it('should have marker', fakeAsync(() => {
        // Check if html element is valid
        const marker = fixture.debugElement.nativeElement.querySelector('.gct-details-panel-range > div > div > div');
    ...
    it('should have footer', () => {
        // Check if html element is valid
        const footer = fixture.debugElement.nativeElement.querySelector('.gct-details-panel-footer');
