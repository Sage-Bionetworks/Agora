...
import { SimilarGenesNetworkComponent } from './sgn-dialog.component';
...
describe('Component: SGNDialog', () => {
    let component: SimilarGenesNetworkComponent;
    let fixture: ComponentFixture<SimilarGenesNetworkComponent>;
    ...
    beforeEach(async(() => {
        TestBed.configureTestingModule({
            declarations: [
                ...
                MockComponent(SimilarGenesNetworkComponent)
            ],
        ...
        fixture = TestBed.createComponent(SimilarGenesNetworkComponent);
