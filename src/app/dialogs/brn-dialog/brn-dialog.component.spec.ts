...
import { BRAinRegionNetworkComponent } from './brn-dialog.component';
...
describe('Component: BRNDialog', () => {
    let component: BRAinRegionNetworkComponent;
    let fixture: ComponentFixture<BRAinRegionNetworkComponent>;
    ...
    beforeEach(async(() => {
        ...
        fixture = TestBed.createComponent(BRAinRegionNetworkComponent);
