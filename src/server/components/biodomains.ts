...
export async function getAllBioDomains() {
  ...
  result = await AllBioDomainsCollection.find()
    .lean()
    .sort()
    .exec();
...
export async function getAllGeneBioDomains() {
  ...
  result = await BioDomainsCollection.find()
    .lean()
    .sort()
    .exec();
...
// Routes
// -------------------------------------------------------------------------- //
export async function allBiodomainsRoute(
  req: Request,
  res: Response,
  next: NextFunction
) {
...
export async function biodomainsRoute(
  req: Request,
  res: Response,
  next: NextFunction
) {
